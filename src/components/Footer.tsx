        ...
        <footer>
            <div className="container footer-grid">
                <div className="row footer-grid-row">
                    ...
                    <div className="col-5 col-md-4 text-center d-flex align-content-center flex-wrap footer-icon-col" >
                        <a className="box me-2 ms-sm-5 footer-icon-link" id="first-icon" href="https://www.facebook.com/residentventures">
                        ...
                        <a className="box me-2 footer-icon-link" href="https://www.linkedin.com/company/resident-ventures/about/">
                        ...
                        <a className="box me-0 me-sm-2 footer-icon-link" href="https://www.instagram.com/meetresident/?hl=en">
